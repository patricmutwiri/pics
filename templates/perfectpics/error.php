		...
		<div class="error-page-inner">
			<div>
				<div class="container">
					...
					<a class="btn btn-primary btn-lg error-button" href="<?php echo $this->baseurl; ?>/" title="<?php echo JText::_('HOME'); ?>"><i class="fa fa-chevron-left"></i> <?php echo JText::_('HELIX_GO_BACK'); ?></a>
