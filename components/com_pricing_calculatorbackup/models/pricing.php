...
/**
 * Item Model for pricing.
 *
 * @package     Pricing_calculator
 * @subpackage  Models
 */
class Pricing_calculatorModelPricing extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_PRICING_CALCULATOR';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_pricing_calculator.pricing';
	 ...
	 */
	public function getTable($type = 'Pricing', $prefix = 'Pricing_calculatorTable', $config = array())
	{
	...
	{
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('pricing.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($data))
				{
					JError::raiseError(404, JText::_('COM_PRICING_CALCULATOR_ERROR_FEED_NOT_FOUND'));
				}
