...
/**
 * Item Model for paper_type.
 *
 * @package     Pricing_calculator
 * @subpackage  Models
 */
class Pricing_calculatorModelPaper_type extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_pricing_calculator.paper_type';
	 ...
	 */
	public function getTable($type = 'Paper_type', $prefix = 'Pricing_calculatorTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('paper_type.id');
