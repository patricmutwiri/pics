...
';
	...
	function listing(){
		...
		if(!empty($menuparams)) {
			...
			if(!empty($data->{"menu-meta_description"})) $doc->setMetaData('description', $data->{"menu-meta_description"});
			if(!empty($data->{"menu-meta_keywords"})) $doc->setMetaData('keywords', $data->{"menu-meta_keywords"});
		}
