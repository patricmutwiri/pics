 ...
 * @subpackage  Models
 */
class ProductsModelLogo extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_products.logo';
	 ...
	 */
	public function getTable($type = 'Logo', $prefix = 'ProductsTable', $config = array())
	{
	...
	{
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('logo.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($data))
				{
					JError::raiseError(404, JText::_('COM_PRODUCTS_ERROR_FEED_NOT_FOUND'));
				}
