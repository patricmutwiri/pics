...
/**
 * Item Model for end_sheet.
 *
 * @package     Products
 * @subpackage  Models
 */
class ProductsModelEnd_sheet extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_products.end_sheet';
	 ...
	 */
	public function getTable($type = 'End_sheet', $prefix = 'ProductsTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('end_sheet.id');
