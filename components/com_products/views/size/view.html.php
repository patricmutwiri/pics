...
/**
 * Size item view class.
 *
 * @package     Products
 * @subpackage  Views
 */
class ProductsViewSize extends JViewLegacy
{
	protected $item;
	protected $form;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		if (empty($this->item))
		{
			$app->redirect(JRoute::_('index.php?option=com_products&view=sizes'), JText::_('JERROR_NO_ITEMS_SELECTED'));
		}
