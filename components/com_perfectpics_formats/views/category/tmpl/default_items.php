...
<?php if (empty($this->items)) : ?>
	<p><?php echo JText::_('COM_PERFECTPICS_FORMATS_NO_PERFECTPICS_FORMATSS'); ?></p>
<?php else : ?>
		...
		<?php if ($this->params->get('filter_field') != 'hide') :?>
			<div class="btn-group">
				<label class="filter-search-lbl element-invisible" for="filter-search">
					<?php echo JText::_('COM_PERFECTPICS_FORMATS_'.$this->params->get('filter_field').'_FILTER_LABEL').'&#160;'; ?>
				</label>
				<input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="inputbox" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_PERFECTPICS_FORMATS_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_PERFECTPICS_FORMATS_'.$this->params->get('filter_field').'_FILTER_LABEL'); ?>" />
			</div>
		<?php endif; ?>
		...
		<thead>
			<tr>
				...
				<?php if ($this->user->authorise('core.edit') || $this->user->authorise('core.edit.own')) : ?>
					<th id="categorylist_header_edit"><?php echo JText::_('COM_PERFECTPICS_FORMATS_EDIT_ITEM'); ?></th>
				<?php endif; ?>
			</tr>
		</thead>
		<?php endif; ?>
...
<?php // Code to add a link to submit an perfectpics_formats. ?>
