...
class Perfectpics_formatsViewPerfectPics_Formats extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if (empty($this->item))
		{
			$app->redirect(JRoute::_('index.php?option=com_perfectpics_formats&view=perfectpics_formatss'), JText::_('JERROR_NO_ITEMS_SELECTED'));
		}
		...
		if (!$this->item->id && !$user->authorise("core.create", "com_perfectpics_formats"))
		{
			throw new Exception(JText::_('JERROR_ALERTNOAUTHOR'));
		}
