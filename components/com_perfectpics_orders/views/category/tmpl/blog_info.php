...
<?php if ($position == 'above' && ($blockPosition == 0 || $blockPosition == 2) || $position == 'below' && ($blockPosition == 1)) : ?>
	<dt class="article-info-term">
		...
		<?php if ($params->get('info_block_show_title', 1)) : ?>
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_PERFECTPICS_ORDERS_INFO'); ?>
		<?php endif; ?>
	</dt>
	...
	<dd class="parent-category-name">
		...
		<?php if ($params->get('link_parent_category', 1) && !empty($this->item->parent_slug)) : ?>
			<?php $url = '<a href="' . JRoute::_(Perfectpics_ordersHelperRoute::getCategoryRoute($this->item->parent_slug)) . '" itemprop="genre">' . $title . '</a>'; ?>
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_PARENT') . ": " . $url; ?>
		<?php else : ?>
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_PARENT') . ": " . '<span itemprop="genre">' . $title . '</span>'; ?>
		<?php endif; ?>
	</dd>
	<?php endif; ?><?php /*
	...
	<dd class="category-name">
		...
		<?php if ($params->get('link_category', 1) && $this->item->catslug) : ?>
			<?php $url = '<a href="' . JRoute::_(Perfectpics_ordersHelperRoute::getCategoryRoute($this->item->catslug)) . '" itemprop="genre">' . $title . '</a>'; ?>
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_CATEGORY') . ": " . $url; ?>
		<?php else : ?>
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_CATEGORY') . ": " . '<span itemprop="genre">' . $title . '</span>'; ?>
		<?php endif; ?>
	</dd>
	<?php endif; ?> */ ?>
	...
	<dd class="published">
		...
		<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'c'); ?>" itemprop="datePublished">
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_PUBLISHED_DATE_ON') . ": " . JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC3')); ?>
		</time>
	</dd>
	<?php endif; ?>
<?php endif; ?>
<?php if ($position == 'above' && ($blockPosition == 0) || $position == 'below' && ($blockPosition == 1 || $blockPosition == 2)) : ?>
	...
	<dd class="create">
		...
		<time datetime="<?php echo JHtml::_('date', $this->item->created, 'c'); ?>" itemprop="dateCreated">
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_CREATED_DATE_ON') . ": " . JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_LC3')); ?>
		</time>
	</dd>
	<?php endif; ?>
	...
	<dd class="modified">
		...
		<time datetime="<?php echo JHtml::_('date', $this->item->modified, 'c'); ?>" itemprop="dateModified">
			<?php echo JText::_('COM_PERFECTPICS_ORDERS_LAST_UPDATED') . ": " . JHtml::_('date', $this->item->modified, JText::_('DATE_FORMAT_LC3')); ?>
		</time>
	</dd>
	<?php endif; ?>
<?php endif; ?>
