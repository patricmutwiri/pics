...
/**
 * Item Model for product_cover.
 *
 * @package     Pricing_calculator
 * @subpackage  Models
 */
class Pricing_calculatorModelProduct_cover extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_pricing_calculator.product_cover';
	 ...
	 */
	public function getTable($type = 'Product_cover', $prefix = 'Pricing_calculatorTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('product_cover.id');
