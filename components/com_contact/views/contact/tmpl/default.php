...
?>
<div class="contact grid-construct-x<?php echo $this->pageclass_sfx?>" itemscope itemtype="https://schema.org/Person">
	...
	<?php echo $this->loadTemplate('address'); ?> <!-- address loaded here -->
	...
	<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
		<?php if ($this->params->get('presentation_style') == 'sliders') : ?>
			<?php echo JHtml::_('bootstrap.addSlide', 'slide-contact', JText::_('Location'), 'display-misc'); ?>
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'tabs') : ?>
	...
	<?php echo $this->loadTemplate('map'); ?> <!-- introduce map here -->
...
<script type="text/javascript" async="async" defer="defer" data-cfasync="false" src="https://mylivechat.com/chatinline.aspx?hccid=57805386"></script>
