...
class UsersViewProfile extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$usrimage = JComponentHelper::getParams('com_users')->get('userimage');
		//$myparam = JComponentHelper::getParams('com_mycomponent')->get('myparam');
	 //$userImage = $this->item->params->get('userimage')
	 // Getting menu Param
//$ImageParam = JFactory::getApplication()->getParams();
//$customLimit = $ImageParam->get(userimage, 10);
		...
		//var_dump($params->userimage);
		//var_dump($customLimit);
