...
/**
 * Item Model for experts.
 *
 * @package     Perfect_pics_experts
 * @subpackage  Models
 */
class Perfect_pics_expertsModelExperts extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_PERFECT_PICS_EXPERTS';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_perfect_pics_experts.experts';
	 ...
	 */
	public function getTable($type = 'Experts', $prefix = 'Perfect_pics_expertsTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('experts.id');
