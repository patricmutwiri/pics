...
/**
 * Item Model for perfectpics_product.
 *
 * @package     Perfectpics_products
 * @subpackage  Models
 */
class Perfectpics_productsModelPerfectPics_Product extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_PERFECTPICS_PRODUCTS';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_perfectpics_products.perfectpics_product';
	 ...
	 */
	public function getTable($type = 'PerfectPics_Product', $prefix = 'Perfectpics_productsTable', $config = array())
	{
	...
	{
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('PerfectPics_Product.id');
		...
		if (!isset($this->_item[$pk]))
		{
			...
			/*	if (empty($data))
				{
					JError::raiseError(404, JText::_('COM_PERFECTPICS_PRODUCTS_ERROR_FEED_NOT_FOUND'));
				}*/
