 ...
 * @subpackage  Models
 */
class Perfectpics_productsModelProductsizes extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__productsizes AS a');
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__productsizes AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
