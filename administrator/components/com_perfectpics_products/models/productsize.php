 ...
 * @subpackage  Models
 */
class Perfectpics_productsModelProductsize extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_perfectpics_products.productsize';
	 ...
	 */
	public function getTable($type = 'Productsize', $prefix = 'Perfectpics_productsTable', $config = array())
	{
