 ...
 * @subpackage  Models
 */
class Perfectpics_productsModelDiscount extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_perfectpics_products.discount';
	 ...
	 */
	public function getTable($type = 'Discount', $prefix = 'Perfectpics_productsTable', $config = array())
	{
