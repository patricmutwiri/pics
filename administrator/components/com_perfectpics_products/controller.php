...
class Perfectpics_productsController extends JControllerLegacy
{
	/**
	 ...
	 * @since  12.2
	 */
	protected $default_view = 'perfectpics_products';
    ...
    public function display($cachable = false, $urlparams = false)
	{
		...
		$vName   = $this->input->getCmd('view', 'perfectpics_products');
