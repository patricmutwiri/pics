...
require_once JPATH_COMPONENT.'/helpers/discounts.php';

/**
 * Discounts list view class.
 *
 * @package     Perfectpics_products
 * @subpackage  Views
 */
class Perfectpics_productsViewDiscounts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Perfectpics_productsHelper::addSubmenu('discounts');
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				JToolbarHelper::checkin('discounts.checkin');
            }
		}
