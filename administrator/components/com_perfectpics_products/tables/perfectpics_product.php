 ...
 * @subpackage  Tables
 */
class Perfectpics_productsTablePerfectPics_Product extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__perfectpics_product', 'id', $db);
	}
	...
	{
        $k = $this->_tbl_key;
        return 'com_perfectpics_products.perfectpics_product.' . (int) $this->$k;
    }
