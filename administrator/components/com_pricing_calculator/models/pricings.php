	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'a.publish_down', 'publish_down','ordering', 'state', 'item_name', 'item_image', 'item_dimensions', 'size', 'cover', 'paper', 'no_pages', 'price'
			);
		}
	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('a.item_name LIKE' . $s . ' OR a.item_image LIKE' . $s . ' OR a.item_dimensions LIKE' . $s . ' OR a.size LIKE' . $s . ' OR a.cover LIKE' . $s . ' OR a.paper LIKE' . $s . ' OR a.no_pages LIKE' . $s . ' OR a.price LIKE' . $s );
			}
		}
