...
/**
 * Item Model for cover.
 *
 * @package     Products
 * @subpackage  Models
 */
class ProductsModelCover extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_products.cover';
	 ...
	 */
	public function getTable($type = 'Cover', $prefix = 'ProductsTable', $config = array())
	{
