...
class ProductsViewCovers extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		ProductsHelper::addSubmenu('covers');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PRODUCTS_COVERS_VIEW_COVERS_TITLE'));
		
		if ($canDo->get('core.create'))
		{
			JToolBarHelper::addNew('cover.add','JTOOLBAR_NEW');
		}

		if (($canDo->get('core.edit') || $canDo->get('core.edit.own')) && isset($this->items[0]))
		{
			JToolBarHelper::editList('cover.edit','JTOOLBAR_EDIT');
		}
		...
		if ($canDo->get('core.edit.state'))
		{
            if (isset($this->items[0]->published))
			{
				...
				JToolbarHelper::publish('covers.publish', 'JTOOLBAR_PUBLISH', true);
				JToolbarHelper::unpublish('covers.unpublish', 'JTOOLBAR_UNPUBLISH', true);
            } 
			else if (isset($this->items[0]))
			{
                // Show a direct delete button
                JToolBarHelper::deleteList('', 'covers.delete','JTOOLBAR_DELETE');
            }

            if (isset($this->items[0]->published))
			{
			    JToolBarHelper::divider();
			    JToolBarHelper::archiveList('covers.archive','JTOOLBAR_ARCHIVE');
            }
            
			if (isset($this->items[0]->checked_out))
			{
				JToolbarHelper::checkin('covers.checkin');
            }
		}
        ...
        if (isset($this->items[0]->published))
		{
			...
			{
			    JToolBarHelper::deleteList('', 'covers.delete','JTOOLBAR_EMPTY_TRASH');
			    JToolBarHelper::divider();
		    }
			else if ($state->get('filter.published') != -2 && $canDo->get('core.edit.state'))
			{
			    JToolBarHelper::trash('covers.trash','JTOOLBAR_TRASH');
			    JToolBarHelper::divider();
		    }
        }
