...
<form action="<?php echo JRoute::_('index.php?option=com_products&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="paper-form" class="form-validate">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
		...
		<div class="row-fluid">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('paper_image'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('paper_image'); ?></div>
			</div>			
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('paper_price'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('paper_price'); ?></div>
			</div>
				</div>
			</div>
			<div class="span3">
