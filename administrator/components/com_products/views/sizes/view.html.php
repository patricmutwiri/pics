...
/**
 * Sizes list view class.
 *
 * @package     Products
 * @subpackage  Views
 */
class ProductsViewSizes extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ProductsHelper::addSubmenu('sizes');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PRODUCTS_SIZES_VIEW_SIZES_TITLE'));
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			else if (isset($this->items[0]))
			{
                ...
                JToolBarHelper::deleteList('', 'sizes.delete','JTOOLBAR_DELETE');
            }
