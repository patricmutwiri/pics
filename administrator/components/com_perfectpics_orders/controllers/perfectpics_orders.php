...
class Perfectpics_ordersControllerPerfectPics_Orders extends JControllerForm
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('PerfectPics_Orders', 'Perfectpics_ordersModel', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_perfectpics_orders&view=perfectpics_orderss' . $this->getRedirectToListAppend(), false));
