...
class Perfect_pics_expertsControllerExperts extends JControllerForm
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Experts', 'Perfect_pics_expertsModel', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_perfect_pics_experts&view=expertss' . $this->getRedirectToListAppend(), false));
