...
class FAQBookProModelQuestions extends JModelList
{
		...
		$query->select(
			$this->getState(
				...
				'a.id, a.title, a.alias, a.checked_out, a.checked_out_time, a.topicid' .
					', a.state, a.access, a.created, a.created_by, a.created_by_alias, a.created_by_email, a.ordering, a.featured, a.language, a.hits' .
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__minitek_faqbook_questions AS c ON c.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
