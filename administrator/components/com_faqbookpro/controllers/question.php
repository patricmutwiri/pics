...
class FAQBookProControllerQuestion extends JControllerForm
{
	...
	protected function postSaveHook(JModelLegacy $model, $validData = array())
	{
		...
		// Set as not answered if articletext is deleted and question is answered
		if ((!isset($item->articletext) || !$item->articletext) && isset($item->answered) && $item->answered == 1)
		{
			// Set question as not answered
			$model->questionNotAnswered($item->id);
		}
