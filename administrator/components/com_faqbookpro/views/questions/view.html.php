...
class FAQBookProViewQuestions extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_FAQBOOKPRO_QUESTIONS'), 'question');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			JToolbarHelper::custom('questions.featured', 'featured.png', 'featured_f2.png', 'JFEATURE', true);
			JToolbarHelper::custom('questions.unfeatured', 'unfeatured.png', 'featured_f2.png', 'JUNFEATURE', true);
	...
	protected function getSortFields()
	{
		return array(
			...
			'topic_title' 	 => JText::_('COM_FAQBOOKPRO_TOPIC'),
