...
class Perfectpics_formatsController extends JControllerLegacy
{
	/**
	 ...
	 * @since  12.2
	 */
	protected $default_view = 'perfectpics_formatss';
    ...
    public function display($cachable = false, $urlparams = false)
	{
		...
		$vName   = $this->input->getCmd('view', 'perfectpics_formatss');
