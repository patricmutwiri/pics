	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'a.publish_down', 'publish_down','ordering', 'state', 'formats_icon', 'format_title', 'format_size', 'price_from', 'pages', 'format_price'
			);
		}
	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('a.formats_icon LIKE' . $s . ' OR a.format_title LIKE' . $s . ' OR a.format_size LIKE' . $s . ' OR a.price_from LIKE' . $s . ' OR a.pages LIKE' . $s . ' OR a.format_price LIKE' . $s );
			}
		}
